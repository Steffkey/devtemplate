...
generate_scope_panel <- function(scope_sheets, scope_items){ 
  tabsetPanel(id = "scope_panel",#paste0(chosen_template), 
              # "prp", #ACHTUNG! Anzahl der submenus wird hier manuell festgelegt
              tabPanel(scope_sheets[1],
                       uiOutput("contributor_ui"), 
                       actionButton("add_btn", "add contributor"),
                       actionButton("rm_btn", "remove contributor"),
                       br(),
              ...
              tabPanel(scope_sheets[2],
                       scope_items[2],
                       actionButton("next2", "Next page"),
                       
              ),
              tabPanel(scope_sheets[3],
                       scope_items[3],
                       actionButton("next3", "Next page"),
                       
              ),
              tabPanel(scope_sheets[4],
                       scope_items[4],
                       actionButton("next4", "Next page"),
                       
              ),
              tabPanel(scope_sheets[5],
                       scope_items[5],
                       actionButton("next5", "Next page"),
                       
              ),
              tabPanel(scope_sheets[6],
                       scope_items[6],
...
# output$scope_panel <- renderUI({generate_scope_panel(scope_sheets, scope_items)}) # usage

#### generate_scope_panel 
generate_dev_panel <- function(dev_sheets, dev_items){ 
  tabsetPanel(id = "dev_panel",#paste0(chosen_template), 
              # "prp", #ACHTUNG! Anzahl der submenus wird hier manuell festgelegt
              tabPanel(dev_sheets[1],
                       # uiOutput("contributor_ui"), 
                       # actionButton("add_btn", "add contributor"),
                       # actionButton("rm_btn", "remove contributor"),
                       br(),
              ...
              tabPanel(dev_sheets[2],
                       dev_items[2],
                       actionButton("next2", "Next page"),
                       
              ),
              tabPanel(dev_sheets[3],
                       dev_items[3],
                       actionButton("next3", "Next page"),
                       
              ),
              tabPanel(dev_sheets[4],
                       dev_items[4],
                       actionButton("next4", "Next page"),
                       
              ),
              tabPanel(dev_sheets[5],
                       dev_items[5],
                       actionButton("next5", "Next page"),
                       
              ),
              tabPanel(dev_sheets[6],
                       dev_items[6],
                       #actionButton("next6", "Next page"), #die letzte Seite kriegt keinen Next-Button,
...
# output$dev_panel <- renderUI({generate_dev_panel(dev_sheets, dev_items)}) # usage
